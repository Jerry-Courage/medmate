...
export default function LoginScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      >
        {/* Phone/Email */}
        <Text style={[styles.label, { color: colors.mutedForeground }]}>Phone/Email</Text>
        ...
        <View style={styles.socialRow}>
          <SocialBtn icon="logo-apple" bgColor="#000" />
          <SocialBtn icon="logo-google" bgColor="#DB4437" />
          <SocialBtn icon="logo-facebook" bgColor="#1877F2" />
        </View>
...
function SocialBtn({ icon, bgColor }: { icon: string; bgColor: string }) {
  return (
    <Pressable
      style={({ pressed }) => [styles.socialBtn, { backgroundColor: bgColor, opacity: pressed ? 0.8 : 1 }]}
    >
